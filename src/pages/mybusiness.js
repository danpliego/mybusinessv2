...
import { BannerContainer } from "./mybusiness";
import { BannerContent } from "./mybusiness";
import { BlueArea } from "./mybusiness";
    ...
    <ProductBlueArea>
      ...
      <Comp.Width75>
        ...
        <ul className="font-xl">
          ...
          <li>
            Se puede instalar a partir de Windows 7 service pack 1 hasta Windows
            10.
          </li>
          <li>
            Puedes cambiar a la versión más reciente pagando una actualización.
          </li>
        </ul>
      </Comp.Width75>
      <Comp.Width50>
