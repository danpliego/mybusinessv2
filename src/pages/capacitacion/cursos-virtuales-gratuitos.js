          ...
          <div style={{ padding: "2rem" }}>
            <table>
              ...
              <tr>
                ...
                <td>
                  Dirigido a todos los nuevos usuarios que acaban de adquirir el
                  sistema y desean saber la correcta implementación de este en
                  su negocio.
                </td>
                  ...
                  <table className="table unmargin">
                    ...
                    <tr>
                      ...
                      <td>
                        <ol>
                          <li>
                            Instalar, configurar y operar el módulo MyCFDI para
                            Factura Electrónica
                          </li>
                          <li>
              ...
              <tr>
                ...
                <td width="20%">
                  ...
                  implementación de la factura electrónica en cualquier giro de
                  negocio.
                </td>
                <td className="reset-padding">
                  <table className="table unmargin">
